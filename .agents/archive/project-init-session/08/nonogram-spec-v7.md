...
Copy verbatim rather than rebuilding, all from `${CH_01_LOCAL_REPO}`: `${CH_01_LESSONS_DIR}/GLOSSARY.md`,
`${CH_01_LESSONS_DIR}/COURSE_STANDARDS.md`, `${CH_01_LESSONS_DIR}/TESTING_STANDARDS.md`, and
`${CHECKSTYLE_CONFIG}`. Those are frozen reference, not exercises.
